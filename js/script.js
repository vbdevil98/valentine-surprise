document.addEventListener('DOMContentLoaded', function() {
    ...
    if (timerElement) {
        ...
        function updateTimer() {
            ...
            timerElement.innerHTML = `
                ...
                <div style="font-size: 1.3rem; font-weight: 700; color: #d63031; background: rgba(255,255,255,0.5); padding: 10px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.8);">
    ...
    if (noBtn) {
        ...
        // Trigger on Hover (Desktop) & Touch (Mobile)
...
function redeemCoupon(element) {
    if (!element.classList.contains("redeemed")) {
        ...
        // Check if confetti exists (it might not be loaded on every page)
